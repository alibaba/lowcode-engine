...
@observer
class SettingFieldView extends Component<
  SettingFieldViewProps,
  SettingFieldViewState
> {
  ...
  render() {
    ...
    function shallowIntl(data: any): any {
...
class SettingGroupView extends Component<SettingGroupViewProps> {
  ...
  render() {
    ...
    return createField(
      {
        meta:
          field.componentMeta?.npm || field.componentMeta?.componentName || '',
        title: field.title,
        // editor: field.editor,
        collapsed: !field.expanded,
        onExpandChange: (expandState) => field.setExpanded(expandState),
